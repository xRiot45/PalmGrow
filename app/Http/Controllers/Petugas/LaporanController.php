...
class LaporanController extends Controller
{
    ...
    {
        $lokasi_kebun = Kebun::select('id', 'lokasi')->get();
        return view('pages.petugas.laporan.create', [
            'lokasi_kebun' => $lokasi_kebun,
        ]);
    }
    ...
    public function store(LaporanRequest $request): RedirectResponse
    {
        ...
        if ($tambah_data) {
            return redirect()->route('petugas.laporan.index')->with('success', 'Laporan berhasil ditambahkan');
        }

        return redirect()->route('petugas.laporan.index')->with('error', 'Laporan gagal ditambahkan');
    }
    ...
    public function edit(int $id): View
    {
        ...
        return view('pages.petugas.laporan.edit', [
            'data' => $laporan,
            'lokasi_kebun' => $lokasi_kebun,
        ]);
    }
    ...
    public function update(LaporanRequest $request, $id): RedirectResponse
    {
        ...
        return redirect()->route('petugas.laporan.index')->with('error', 'Laporan gagal diperbarui');
    }
    ...
    public function destroy(int $id): RedirectResponse
    {
        ...
        if ($laporan) {
            ...
            if ($hapus_data) {
                return redirect()->route('petugas.laporan.index')->with('success', 'Laporan beserta file berhasil dihapus');
            }

            return redirect()->route('petugas.laporan.index')->with('error', 'Laporan beserta file gagal dihapus');
        }

        return redirect()->route('petugas.laporan.index')->with('error', 'Laporan tidak ditemukan');
    }
    ...
    public function view_pdf($id): View
    {
        ...
        return view('pages.petugas.laporan.view-pdf', [
            'data' => $bukti_laporan,
            'pdfPath' => $pdfPath,
        ]);
    }
