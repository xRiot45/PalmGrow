      ...
      <div class="card">
        <div class="card-body overflow-hidden position-relative">
          <iconify-icon icon="iconamoon:certificate-badge-duotone"
            class="fs-36 text-warning"></iconify-icon>
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="avatar-group">
                      ...
                      <a href="javascript:void(0);" class="avatar-group-item">
                        <img src="/images/users/avatar-3.jpg" alt="avatar-3"
                          class="img-fluid avatar-xs rounded-circle avatar-border" />
                      </a>
                      <a href="javascript:void(0);" class="avatar-group-item">
                        <img src="/images/users/avatar-4.jpg" alt="avatar-4"
                          class="img-fluid avatar-xs rounded-circle avatar-border" />
                      </a>
                    </td>
                    <td>12 April 2024</td>
                  ...
                  <tr>
                    ...
                    <td class="avatar-group">
                      <a href="javascript:void(0);" class="avatar-group-item">
                        <img src="/images/users/avatar-1.jpg" alt="avatar-1"
                          class="img-fluid avatar-xs rounded-circle avatar-border" />
                      </a>
                      <a href="javascript:void(0);" class="avatar-group-item">
                        <img src="/images/users/avatar-5.jpg" alt="avatar-5"
                          class="img-fluid avatar-xs rounded-circle avatar-border" />
                      </a>
                    </td>
                    <td>10 April 2024</td>
                  ...
                  <tr>
                    ...
                    <td class="avatar-group">
                      ...
                      <a href="javascript:void(0);" class="avatar-group-item">
                        <img src="/images/users/avatar-7.jpg" alt="avatar-7"
                          class="img-fluid avatar-xs rounded-circle avatar-border" />
                      </a>
                      <a href="javascript:void(0);" class="avatar-group-item">
                        <img src="/images/users/avatar-6.jpg" alt="avatar-6"
                          class="img-fluid avatar-xs rounded-circle avatar-border" />
                      </a>
                    </td>
                    <td>25 March 2024</td>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="progress progress-sm">
                        <div class="progress-bar bg-blue" role="progressbar" style="width: 21%"
          ...
          <div class="p-3" data-simplebar style="max-height: 386px;">
            <div class="form-check form-todo ps-4">
              <input type="checkbox" class="form-check-input rounded-circle mt-0 fs-18"
                id="customCheck1">
              <label class="form-check-label" for="customCheck1">Review system logs for any reported
                errors</label>
            </div>
            <div class="form-check form-todo py-1 my-2 ps-4">
              <input type="checkbox" class="form-check-input rounded-circle mt-0 fs-18" checked
                id="customCheck2">
              <label class="form-check-label" for="customCheck2">Conduct user testing to identify
                potential bugs</label>
            </div>
            <div class="form-check form-todo py-1 my-2 ps-4">
              <input type="checkbox" class="form-check-input rounded-circle mt-0 fs-18"
                id="customCheck3">
            ...
            <div class="form-check form-todo py-1 my-2 ps-4">
              <input type="checkbox" class="form-check-input rounded-circle mt-0 fs-18"
                id="customCheck4">
              <label class="form-check-label" for="customCheck4">Prioritize bugs based on severity
                and impact </label>
            </div>
            <div class="form-check form-todo py-1 my-2 ps-4">
              <input type="checkbox" class="form-check-input rounded-circle mt-0 fs-18"
                id="customCheck5">
              <label class="form-check-label" for="customCheck5">Investigate and analyze the root
                cause of each bug</label>
            </div>
            <div class="form-check form-todo py-1 my-2 ps-4">
              <input type="checkbox" class="form-check-input rounded-circle mt-0 fs-18"
                id="customCheck6">
              <label class="form-check-label" for="customCheck6">Develop and implement fixes for the
                identified bugs</label>
            </div>
            <div class="form-check form-todo py-1 my-2 ps-4">
              <input type="checkbox" class="form-check-input rounded-circle mt-0 fs-18"
                id="customCheck7">
          ...
          <div class="p-3" data-simplebar style="max-height: 400px;">
            <div class="d-flex align-items-center mb-3">
              <div class="flex-shrink-0">
                <img src="/images/users/avatar-10.jpg" class="img-fluid avatar-sm rounded me-2"
                  alt="avatar-5" />
              </div>
            ...
            <div class="d-flex align-items-center mb-3">
              <div class="flex-shrink-0">
                <img src="/images/users/avatar-9.jpg" class="img-fluid avatar-sm rounded me-2"
                  alt="avatar-6" />
              </div>
              <div class="flex-grow-1">
            ...
            <div class="d-flex align-items-center mb-3">
              <div class="flex-shrink-0">
                <img src="/images/users/avatar-8.jpg" class="img-fluid avatar-sm rounded me-2"
                  alt="avatar-7" />
              </div>
              <div class="flex-grow-1">
            ...
            <div class="d-flex align-items-center mb-3">
              <div class="flex-shrink-0">
                <img src="/images/users/avatar-7.jpg" class="img-fluid avatar-sm rounded me-2"
                  alt="avatar-8" />
              </div>
              <div class="flex-grow-1">
            ...
            <div class="d-flex align-items-center mb-3">
              <div class="flex-shrink-0">
                <img src="/images/users/avatar-6.jpg" class="img-fluid avatar-sm rounded me-2"
                  alt="avatar-9" />
              </div>
              <div class="flex-grow-1">
            ...
            <div class="d-flex align-items-center mb-3">
              <div class="flex-shrink-0">
                <img src="/images/users/avatar-5.jpg" class="img-fluid avatar-sm rounded me-2"
                  alt="avatar-5" />
              </div>
              <div class="flex-grow-1">
                <h5 class="mb-1 fs-14"><a href="#!">Victoria P. Miller</a></h5>
            ...
            <div class="d-flex align-items-center mb-3">
              <div class="flex-shrink-0">
                <img src="/images/users/avatar-4.jpg" class="img-fluid avatar-sm rounded me-2"
                  alt="avatar-6" />
              </div>
              <div class="flex-grow-1">
                <h5 class="mb-1 fs-14"><a href="#!">Dallas C. Payne</a></h5>
            ...
            <div class="d-flex align-items-center mb-3">
              <div class="flex-shrink-0">
                <img src="/images/users/avatar-3.jpg" class="img-fluid avatar-sm rounded me-2"
                  alt="avatar-7" />
              </div>
              <div class="flex-grow-1">
                <h5 class="mb-1 fs-14"><a href="#!">Florence A. Lopez</a></h5>
            ...
            <div class="d-flex align-items-center mb-3">
              <div class="flex-shrink-0">
                <img src="/images/users/avatar-2.jpg" class="img-fluid avatar-sm rounded me-2"
                  alt="avatar-8" />
              </div>
              <div class="flex-grow-1">
                <h5 class="mb-1 fs-14"><a href="#!">Gail A. Nix</a></h5>
            ...
            <div class="d-flex align-items-center">
              <div class="flex-shrink-0">
                <img src="/images/users/avatar-1.jpg" class="img-fluid avatar-sm rounded me-2"
                  alt="avatar-9" />
              </div>
              <div class="flex-grow-1">
                <h5 class="mb-1 fs-14"><a href="#!">Lynne J. Petty</a></h5>
