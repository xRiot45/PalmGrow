@extends('layouts.admin/app', ['title' => 'Kategori Panen'])
    ...
    <div class="col-xl-12">
      <div class="card">
        <div class="card-header d-lg-flex justify-content-between align-items-center gap-1">
          <h4 class="card-title">Daftar Kategori Panen</h4>
          <div class="d-flex flex-wrap gap-1 mt-lg-0 mt-3">
            {{-- Button Tambah Kategori Panen --}}
            <a href="{{ route('admin.kategori-panen.create') }}" class="btn btn-md btn-primary">
              <iconify-icon icon="ic:baseline-plus" class="align-middle fs-18">
              </iconify-icon>
              Tambah Kategori Panen
            </a>
            ...
            <a href="{{ route('admin.kategori-panen.index') }}" class="btn btn-md btn-secondary">
              ...
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="filterModalLabel">Filter Data Kategori Panen </h5>
                    ...
                    <form action="{{ route('admin.kategori-panen.index') }}" method="POST">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" id="nama_kategori" name="nama_kategori"
                          class="form-control" value="{{ request()->get('nama_kategori') }}"
                          placeholder="Masukkan nama kategori panen">
                      </div>
                      ...
                      <div class="w-100 d-flex gap-1 justify-content-end">
                        ...
                        <button type="submit" class="btn btn-primary">Cari Kategori Panen</button>
                      </div>
                    </form>
                  </div>
                  {{-- Modal Body End --}}
        ...
        <div class="table-responsive">
          <table class="table align-middle mb-0 table-hover table-centered">
            ...
            <tbody>
              ...
              @else
                @foreach ($data as $index => $kategori_panen)
                  <tr>
                    {{-- No --}}
                    <td class="px-4">
                    ...
                    {{-- Nama Kategori --}}
                    <td> {{ $kategori_panen->nama_kategori }} </td>

                    {{-- Deskripsi --}}
                    <td>
                      {{ Str::words(strip_tags($kategori_panen->deskripsi), 10, '...') }}
                    </td>
                    ...
                    <td>
                      <div class="d-flex gap-2">
                        <a href="{{ route('admin.kategori-panen.edit', [$kategori_panen->id]) }}"
                    ...
                    <div class="modal fade" id="hapusDataModal" tabindex="-1"
                      ...
                      <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form
                              action="{{ route('admin.kategori-panen.destroy', $kategori_panen->id) }}"
                              method="POST">
                              @csrf
                              @method('DELETE')
                              ...
                              <div class="text-center">
                                ...
                                <h4 class="fw-bold">Hapus Data Kategori Panen</h4>
                                <p class="text-muted">
                                  Anda yakin ingin menghapus data kategori panen ini?
                                </p>
                              </div>
