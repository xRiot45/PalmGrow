@extends('layouts.vertical', ['title' => 'Pengguna'])
      ...
      <div class="card">
        <div class="card-header d-lg-flex justify-content-between align-items-center gap-1">
          ...
          <div class="d-flex flex-wrap  gap-1 mt-lg-0 mt-3">
            ...
            <a href="{{ route('admin.pengguna.create') }}" class="btn btn-md btn-primary">
            ...
            <a href="{{ route('admin.pengguna.index') }}" class="btn btn-md btn-secondary">
