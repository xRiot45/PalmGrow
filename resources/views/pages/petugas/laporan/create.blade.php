@extends('layouts.petugas/app', ['title' => 'Tambah Laporan'])
...
@section('content')
  <form method="POST" action="{{ route('petugas.laporan.store') }}" enctype="multipart/form-data">
    @csrf
    <div class="row">
      {{-- Kebun Start --}}
    ...
    <div class="w-100 d-flex gap-1 justify-content-end mt-4">
      <button type="button" class="btn btn-secondary">
        <a href="{{ route('petugas.laporan.index') }}" class="text-white">Kembali</a>
      </button>
