      ...
      <div class="card">
        <div class="card-header d-lg-flex justify-content-between align-items-center gap-1">
          ...
          <div class="d-flex flex-wrap  gap-1 mt-lg-0 mt-3">
            ...
            <a href="{{ route('petugas.laporan.create') }}" class="btn btn-md btn-primary">
            ...
            <a href="{{ route('petugas.laporan.index') }}" class="btn btn-md btn-secondary">
              ...
              <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form action="{{ route('petugas.laporan.index') }}" method="POST">
                      @csrf
                      @method('GET')
                      {{-- Lokasi Kebun --}}
                      <div class="mb-3">
                ...
                @foreach ($data as $index => $laporan)
                  <tr>
                    ...
                    <td class="d-flex items-center gap-2">
                      <a href="{{ route('petugas.laporan.view_pdf', $laporan->id) }}">
                        <button type="button"
                      ...
                      <a href="{{ route('petugas.laporan.download_pdf', $laporan->id) }}"
                        target="_blank">
                        <button type="button"
